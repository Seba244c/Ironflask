 ...
 */
public class BetterImGuiImplGlfw {
    ...
    private final class CreateWindowFunction extends ImPlatformFuncViewport {
        ...
        public void accept(final ImGuiViewport vp) {
            ...
            glfwSetMouseButtonCallback(data.window, BetterImGuiImplGlfw.this::mouseButtonCallback);
            glfwSetScrollCallback(data.window, BetterImGuiImplGlfw.this::scrollCallback);
            glfwSetKeyCallback(data.window, BetterImGuiImplGlfw.this::keyCallback);
            glfwSetCharCallback(data.window, BetterImGuiImplGlfw.this::charCallback);
            glfwSetWindowCloseCallback(data.window, BetterImGuiImplGlfw.this::windowCloseCallback);
            glfwSetWindowPosCallback(data.window, BetterImGuiImplGlfw.this::windowPosCallback);
            glfwSetWindowSizeCallback(data.window, BetterImGuiImplGlfw.this::windowSizeCallback);
